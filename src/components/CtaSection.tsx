                ...
                <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-12 md:p-16 shadow-card">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div className="text-white">
                            <h2 className="text-3xl md:text-5xl font-bold mb-6 leading-tight">Ready to Transform Your
                                Business?</h2>
                            <p className="text-xl mb-8 text-primary-100 max-w-lg">
                                Join over 1,250 entrepreneurs who have launched successful online stores with Oomor's
                                all-in-one platform.
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <button
                                    className="bg-white text-primary-600 hover:bg-primary-50 font-semibold px-8 py-4 rounded-xl shadow-soft transition-all flex items-center justify-center">
                                    Start Free Trial
                        ...
                        <div className="hidden md:block">
                            <div className="relative">
                                <div
                                    className="absolute -top-6 -left-6 w-24 h-24 bg-yellow-400 rounded-full opacity-20 animate-bounce-slow"></div>
                                <div
                                    className="absolute -bottom-6 -right-6 w-32 h-32 bg-primary-400 rounded-full opacity-20 animate-bounce-slow"
