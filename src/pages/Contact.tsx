    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await databaseService.createDocument(
                import.meta.env.VITE_APP_LANDING_DATABASE_ID,
                import.meta.env.VITE_APP_LANDING_CONTACT_SUBMISSION_COLLECTION_ID,
                formData,
            )
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="max-w-7xl mx-auto py-16 px-4 -mt-10">
                <div className="grid md:grid-cols-3 gap-8">
                    <div
                        className="bg-white p-8 rounded-xl shadow-soft hover:shadow-card transition-all duration-300 border border-gray-100">
                        <div
                            className="bg-primary-100 p-3 rounded-full w-12 h-12 flex items-center justify-center mb-4">
                        ...
                        <a href="mailto:contact@oomor.com"
            ...
            <div className="bg-gray-50 py-20 px-4">
                <div className="max-w-5xl mx-auto">
                    <div className="text-center mb-16">
                        <div
                            className="inline-flex items-center px-4 py-1 bg-primary-100 rounded-full text-sm font-medium text-primary-700 mb-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            ...
                            <p className="text-gray-600">
                                Our customer support team is available Monday through Friday from 8am to 5pm in each
                                local time zone. For urgent issues, we offer 24/7 emergency support for our Professional
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            ...
                            <p className="text-gray-600">
                                We aim to respond to all inquiries within 24 hours. For technical support, our response
                                times vary by plan: Starter (24h), Professional (12h), and Enterprise (4h).
                            </p>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            ...
                            <p className="text-gray-600">
                                Yes, phone support is available for all customers. Our Professional and Enterprise plans
                                include priority phone support with dedicated support agents.
                            </p>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm">
                            ...
                            <p className="text-gray-600">
                                The fastest way to get technical help is through our support portal at
                                support.oomor.com. You can also email support@oomor.com or use the contact form on this
                                page.
                            </p>
                        </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto py-20 px-4 text-center">
                <div className="bg-primary-50 p-12 rounded-2xl">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
                        Join our community forum to connect with other users, share ideas, and get help from our
                        community experts.
                    </p>
                    <button
